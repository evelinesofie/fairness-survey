...
<div id="progress">
  <div class="progress">
    ...
    <span class="progress-bold">90%</span>
    </div>
  </div>
</div>

<div class="container col-sm-12" id="content">
    <h1 class="playlist bold">Playlist 3</h1>
        <form method="post">
            <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                ...
                <tbody>
                    ...
                    <tr>
                    <td>Answer with 'disagree a little' here.</td>
                        <td class="centered">
                            <input type="radio" name="control_question_2" value="Fail" required>
                        </td>
                        <td class="centered">
                            <input type="radio" name="control_question_2" value="Pass" required>
                        </td>
                        <td class="centered">
                            <input type="radio" name="control_question_2" value="Fail" required>
                        </td>
...
if (isset($_POST["continue"])) {
    ...
    $q6 = $_POST['q6'];
    $ratio = $_POST['ratio'];
    $control_question_2 = $_POST['control_question_2'];
