...
<div id="progress">
  <div class="progress">
    ...
    <span class="progress-bold">70%</span>
    </div>
  </div>
</div>

<div class="container col-sm-12" id="content">
    <h1 class="playlist bold">Playlist 2</h1>
        <form method="post">
            <div class="col-lg-12">
            ...
            <div class="col-lg-12">
                ...
                <p class="semibold">Please select an option for each statement.</p>
